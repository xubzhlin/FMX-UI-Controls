unit Posix.ffmpeg.libavformat.version;
...
function LIBAVFORMAT_VERSION_INT: Integer;
function LIBAVFORMAT_VERSION_STR: string;
function LIBAVFORMAT_BUILD: Integer;
function LIBAVFORMAT_IDENT: String;

implementation

function LIBAVFORMAT_VERSION_INT: Integer;
begin
  Result := AV_VERSION_INT(LIBAVFORMAT_VERSION_MAJOR, LIBAVFORMAT_VERSION_MINOR, LIBAVFORMAT_VERSION_MICRO);
end;

function LIBAVFORMAT_VERSION_STR: string;
begin
  Result := AV_VERSION(LIBAVFORMAT_VERSION_MAJOR, LIBAVFORMAT_VERSION_MINOR, LIBAVFORMAT_VERSION_MICRO);
end;

function LIBAVFORMAT_BUILD: Integer;
begin
  Result := LIBAVFORMAT_VERSION_INT;
end;

function LIBAVFORMAT_IDENT: String;
begin
  Result := 'Lavf' + AV_STRINGIFY(LIBAVFORMAT_VERSION_STR);
end;
