unit Posix.ffmpeg.libavutil.downmix_info;
 ...
 *)
function av_downmix_info_update_side_data(var frame: AVFrame): Double; cdecl; external libavutil name _PU + 'av_downmix_info_update_side_data';
