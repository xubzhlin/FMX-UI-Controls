unit Posix.ffmpeg.libavutil.cpu;
 ...
 *)
function av_get_cpu_flags: Integer; cdecl; external libavutil name _PU + 'av_get_cpu_flags';

(**
 * Disables cpu detection and forces the specified flags.
 * -1 is a special case that disables forcing of specific flags.
 *)
procedure av_force_cpu_flags(flags: Integer); cdecl; external libavutil name _PU + 'av_force_cpu_flags';
 ...
 *)
procedure av_set_cpu_flags_mask(mask: Integer); cdecl; external libavutil name _PU + 'av_set_cpu_flags_mask';
 ...
 *)
function av_parse_cpu_flags(s: MarshaledAString): Integer; cdecl; external libavutil name _PU + 'av_parse_cpu_flags';
 ...
 *)
function av_parse_cpu_caps(var flags: Integer; s: MarshaledAString): Integer; cdecl; external libavutil name _PU + 'av_parse_cpu_caps';

(**
 * @return the number of logical CPU cores present.
 *)
function av_cpu_count: Integer; cdecl; external libavutil name _PU + 'av_cpu_count';
 ...
 *  present.
 *)
function av_cpu_max_align: NativeInt; cdecl; external libavutil name _PU + 'av_cpu_max_align';
