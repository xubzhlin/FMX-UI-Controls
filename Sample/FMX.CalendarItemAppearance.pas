...
begin
  ...
  if FBitMap=nil then
  begin
    FBitMap:=TBitMap.Create(Trunc(LocalRect.Width*Scale), Trunc(1*Scale));
    FBitMap.Clear(0);
    AtPoint1:=TPointF.Create(0, 0);
    AtPoint2:=TPointF.Create(FBitMap.Width, 0);
  ...
  Canvas.DrawBitmap(FBitMap, RectF(0, 0, FBitMap.Width, FBitMap.Height), RectF(LocalRect.Left, LocalRect.Top, LocalRect.Right, LocalRect.Top+1), 1, True);
end;
